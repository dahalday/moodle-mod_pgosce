...
$string['assessoridnumberonly'] = 'Show student ID only to assigned assessors';
$string['assessoridnumberonly_help'] = 'When enabled, assigned non-editing teachers see the student ID number instead of the student name while assessing. Editing teachers, managers and admins still see both student names and ID numbers.';
