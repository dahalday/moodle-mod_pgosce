...
$string['showgradesingradebook_help'] = 'When enabled, finalized PG OSCE marks are visible to students in the Moodle gradebook. Students see the PG OSCE item on the course page, but station instructions, questions, criteria and assessor comments remain hidden unless separately released.';
$string['gradebookonlyavailable'] = 'This PG OSCE station is available for gradebook visibility only. Station instructions, questions, criteria and assessor comments are hidden.';
