...
$string['assessorprivacysettings'] = 'Assessor privacy';
$string['assessoridentifierdisplay'] = 'Identifier shown to non-editing teachers';
$string['assessoridentifierdisplay_help'] = 'Choose which identifiers assigned non-editing teachers see instead of student names. Editing teachers, managers, admins and course creators still see student names plus all available identifiers.';
$string['assessoridentifierboth'] = 'Moodle user ID and ID number';
$string['assessoridentifiermoodleuserid'] = 'Moodle user ID only';
$string['assessoridentifieridnumber'] = 'ID number only';
...
$string['exportoptionsintro'] = 'Choose an Excel-style CSV export. Average exports combine finalized marker scores only; draft saves are excluded. Individual exports keep each marker on a separate row for audit.';
