...
$string['showgradesingradebook_help'] = 'When enabled, finalized PG OSCE marks are visible to students in the Moodle gradebook even if the activity itself is hidden from the course page.';
